...
Read this reference only when an exact site command, adapter example, desktop integration, or full option list is needed. Prefer `autocli <site> --help` when the installed binary can answer directly.

## Contents

- [Syntax](#syntax)
- [Quick Examples](#quick-examples)
- [Public Mode](#public-mode-no-browser-needed)
- [Public / Browser Mode](#public--browser-mode)
- [Browser Mode](#browser-mode-requires-chrome--extension)
- [Desktop Mode](#desktop-mode-requires-desktop-app-running)
- [Generic Web Reader](#generic-web-reader)
- [AI Discovery Commands](#ai-discovery-commands)
...
**Install (if missing and the user authorizes it):** review the installer first, then use the official AutoCLI installation instructions. On Windows, direct the user to https://github.com/nashsu/AutoCLI.
